...
void AMovementCharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	PlayerInputComponent->BindAction("Sprint", IE_Pressed, this, &AMovementCharacter::Sprint);
	PlayerInputComponent->BindAction("Sprint", IE_Released, this, &AMovementCharacter::StopSprinting);

	PlayerInputComponent->BindAction("Walk", IE_Pressed, this, &AMovementCharacter::Walk);
	PlayerInputComponent->BindAction("Walk", IE_Released, this, &AMovementCharacter::StopWalking);
...
void AMovementCharacter::Sprint()
{
	bIsSprinting = true;
	GetCharacterMovement()->MaxWalkSpeed *= 2.f;
}

void AMovementCharacter::StopSprinting()
{
	bIsSprinting = false;
	GetCharacterMovement()->MaxWalkSpeed /= 2.f;
}

void AMovementCharacter::Walk()
{
	bIsWalking = true;
	GetCharacterMovement()->MaxWalkSpeed /= 2.f;
}

void AMovementCharacter::StopWalking()
{
	bIsWalking = false;
	GetCharacterMovement()->MaxWalkSpeed *= 2.f;
}

void AMovementCharacter::Crouch()
{
